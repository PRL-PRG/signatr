...
gbov_get_random_hash <- function(GBOV) {
  ...
  return(gbov_get_hash(GBOV, index))
}
...
gbov_add_value <- function(GBOV, value) { # This does not work; placeholder.
  GBOV = append(GBOV, value) # scoping issues
  return(length(GBOV[[1]]))
}
